...
temp_df = pd.read_csv(r"C:\Users\albert\PycharmProjects\ms_zqtz\data_merge\a_stock_daily.csv", dtype={"symbol": str})
...
temp_df.to_csv("a_stock_with_name.csv", index=False)
